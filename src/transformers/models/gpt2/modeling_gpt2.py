...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def parallelize(self, device_map=None):
        ...
        self.device_map = (
            get_device_map(len(self.h), range(torch.mlu.device_count())) if device_map is None else device_map
        )
        ...
        for k, v in self.device_map.items():
            for block in v:
                ...
                self.h[block] = self.h[block].to(mlu_device)
        # ln_f to last
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def parallelize(self, device_map=None):
        ...
        self.device_map = (
            get_device_map(len(self.transformer.h), range(torch.mlu.device_count()))
    ...
    def forward(
        ...
        if self.model_parallel:
            torch.mlu.set_device(self.transformer.first_device)
