...
past_versions_testing = {
    ...
    "tensorflow": {
        ...
        # need another `nvidia:mlu` docker image, otherwise GPU not working
        "2.4": {
            "tensorflow": "2.4.4",
            ...
            "base_docker": "nvidia/mlu:11.0.3-cudnn8-devel-ubuntu20.04",
        },
    },
}
...
if __name__ == "__main__":
    ...
    if args.framework == "pytorch":
        mlu = info["mlu"]
    os.system(f"echo \"export CUDA='{mlu}'\" >> ~/.profile")
    print(f"echo \"export CUDA='{mlu}'\" >> ~/.profile")
