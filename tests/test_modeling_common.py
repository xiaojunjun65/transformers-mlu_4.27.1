...
class ModelTesterMixin:
    ...
    def test_model_parallelization(self):
        ...
        def get_current_gpu_memory_use():
            """returns a list of mlu memory allocations per GPU in MBs"""

            per_device_memory = []
            for id in range(torch.mlu.device_count()):
                with torch.mlu.device(id):
                    per_device_memory.append(torch.mlu.memory_allocated() >> 20)
        ...
        for model_class in self.all_parallelizable_model_classes:
            ...
            # Retrieve initial memory usage (can easily be ~0.6-1.5GB if mlu-kernels have been preloaded by previous tests)
    ...
    def test_model_parallel_equal_results(self):
        ...
        for model_class in self.all_parallelizable_model_classes:
            ...
            parallel_output = model(**cast_to_device(inputs_dict, "mlu:0"))
    ...
    def test_model_parallel_beam_search(self):
        ...
        for model_class in all_generative_and_parallelizable_model_classes:
            ...
            model.parallelize()
            model.generate(**cast_to_device(inputs_dict, "mlu:0"), num_beams=2)
...
class ModelUtilsTest(TestCasePlus):
    ...
    def test_from_pretrained_low_cpu_mem_usage_measured(self):
        ...
        # mlu memory tracking and then we should be able to do a much more precise test.
