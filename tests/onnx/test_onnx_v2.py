...
class OnnxExportTestCaseV2(TestCase):
    ...
    @require_vision
    @require_rjieba
    def test_pytorch_export_on_mlu(self, test_name, name, model_name, feature, onnx_config_class_constructor):
        self._onnx_export(test_name, name, model_name, feature, onnx_config_class_constructor, device="mlu")
    ...
    @require_vision
    @require_rjieba
    def test_pytorch_export_encoder_decoder_models_on_mlu(
        self, test_name, name, model_name, feature, onnx_config_class_constructor
    ):
        self._onnx_export_encoder_decoder_models(
            test_name, name, model_name, feature, onnx_config_class_constructor, device="mlu"
        )
