...
def is_mlu_and_apex_available():
    is_using_mlu = torch.mlu.is_available() and torch_device == "mlu"
    return is_using_mlu and is_apex_available()
