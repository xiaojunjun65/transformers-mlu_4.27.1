...
class Wav2Vec2Aligner:
    def __init__(self, model_name, input_wavs_sr, mlu):
        self.mlu = mlu
        self.config = AutoConfig.from_pretrained(model_name)
        self.model = AutoModelForCTC.from_pretrained(model_name)
        self.model.eval()
        if self.mlu:
            self.model.to(device="mlu")
...
def main():
    ...
    aligner = Wav2Vec2Aligner(args.model_name, args.input_wavs_sr, args.mlu)
