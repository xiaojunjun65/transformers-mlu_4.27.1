...
def build_bows_one_hot_vectors(bow_indices, tokenizer, device="mlu"):
...
def run_pplm_example(
    ...
    # set the device
    device = "mlu" if torch.mlu.is_available() and not no_mlu else "cpu"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--no_mlu", action="store_true", help="no mlu")
